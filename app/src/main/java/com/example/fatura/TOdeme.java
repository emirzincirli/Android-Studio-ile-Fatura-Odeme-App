...
public class TOdeme extends AppCompatActivity {

    private EditText edtSozlesmeNo;
    private Button btnOde4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_todeme);

        edtSozlesmeNo = findViewById(R.id.edt_text);
        btnOde4 = findViewById(R.id.buton4);

        btnOde4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (sozlesmeNo.equals(SN)) {
                    ...
                    Toast.makeText(TOdeme.this, "Sözleşme No yanlış", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
