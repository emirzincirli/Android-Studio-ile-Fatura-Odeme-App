...
public class EOdeme extends AppCompatActivity {

    private EditText edtSozlesmeNo;
    private Button btnOde2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eodeme);

        edtSozlesmeNo = findViewById(R.id.edt_text);
        btnOde2 = findViewById(R.id.buton2);

        btnOde2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (sozlesmeNo.equals(SN)) {
                    ...
                    Toast.makeText(EOdeme.this, "Sözleşme No yanlış", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
